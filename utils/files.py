...
def find_files(directory, file_extensions=FILE_EXTENSIONS):
    ...
    :param file_extensions: tuple or list of file extensions
    :return: list of files
    """

    # List of file extensions must be a tuple
    ...
    for filename in os.listdir(directory):
        ...
        if os.path.isfile(filepath) and filename.endswith(file_extensions):
